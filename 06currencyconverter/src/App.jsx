  ...
  return (
    ...
    >
        <div className="w-full">
            <div className="w-full max-w-md mx-auto translate-x-100  border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-blue-100/30">
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        convert()
                ...
                >
                    <div className="w-full mb-1 text-gray-800 font-semibold">
                        <InputBox
                            label="From"
                            amount={amount}
                    ...
                    <div className="w-full mt-1 mb-4 text-gray-900 font-semibold">
                        <InputBox
                            label="To"
